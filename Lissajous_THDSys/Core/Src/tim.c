...
void MX_TIM4_Init(void)
{
  ...
  // 使能TIM4的输入捕获中断
  __HAL_TIM_ENABLE_IT(&htim4, TIM_IT_CC1);  // 通道1中断（周期测量）
  __HAL_TIM_ENABLE_IT(&htim4, TIM_IT_CC2);  // 通道2中断（高电平宽度测量）
  printf("TIM4: Capture interrupts enabled\r\n");
