...
void Set_Prescaler(uint16_t prescaler_value)
{
    ...
    switch(prescaler_value)
    {
        ...
        case 5:
            // 1011
            P0(1); P1(0); P2(1); P3(1);
            CD4053_A(0); CD4052_A(0); CD4052_B(0);
            break;
        case 4:
            // 1100
            P0(1); P1(1); P2(0); P3(0);
            CD4053_A(0),CD4052_A(0); CD4052_B(1);
            break;
        case 3:
            // 1101
            P0(1); P1(1); P2(0); P3(1);
            CD4053_A(0),CD4052_A(1); CD4052_B(0);
            break;
        case 2:
            // 1110
            P0(1); P1(1); P2(1); P3(0);
            CD4053_A(0),CD4052_A(1); CD4052_B(1);
            break;
        case 1:
            // 1111
            P0(1); P1(1); P2(1); P3(1);
            CD4053_A(1),CD4052_A(1); CD4052_B(1);
            break;
        default:
            // 0000
            P0(0); P1(0); P2(0); P3(0);
