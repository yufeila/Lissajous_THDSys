...
{
    HAL_GPIO_WritePin(HC161N_P0_PORT, HC161N_P0_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(HC161N_P1_PORT, HC161N_P1_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(HC161N_P2_PORT, HC161N_P2_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(HC161N_P3_PORT, HC161N_P3_PIN, GPIO_PIN_RESET);
