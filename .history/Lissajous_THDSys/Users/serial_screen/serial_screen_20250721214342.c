...
#define CTRL_TXE_PLL_MULTIPLY 5   // “锁相环倍频”绑定倍频值的文本控件
#define CTRL_TEXT_PLL_MULTIPLY 6   // “锁相环倍频”绑定倍频值的文本控件
...
void NotifyButton(uint16 screen_id, uint16 control_id, uint8  state)
{
    ...
    // 若是“锁相环倍频”按钮被按下
    else if (screen_id == PAGE_MEASURE && control_id == CTRL_BTN_PLL_MULTIPLY)
    {
        SetPLLMultiply(1);
    }
