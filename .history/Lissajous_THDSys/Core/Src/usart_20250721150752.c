...
#define RX_LEN       256                // 建议 ≥ 最大指令长度，比如 CMD_MAX_SIZE=128，就用 256
uint8_t  rxBuf[RX_LEN];                 // DMA 接收原始字节
/* USER CODE END 0 */
...
void MX_USART3_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART3_Init 2 */
    /* —— 下面两行开启 IDLE+DMA 分帧接收 —— */
    HAL_UARTEx_ReceiveToIdle_DMA(&huart3, rxBuf, sizeof());
